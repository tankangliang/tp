    ...
    public static Client[] getSampleClients() {
        return new Client[]{
            new Client(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                new Timezone("GMT+08:00"), new ContractExpiryDate("21-4-2022"),
                new LastModifiedInstant("2020-01-01T00:00:00.000000Z")),
            new Client(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new Timezone("GMT+08:00"), new ContractExpiryDate("12-12-2021"),
            ...
            new Client(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                ...
                new Country("SG"), new Timezone("GMT+08:00"), new ContractExpiryDate("1-4-2023"),
            ...
            new Client(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                ...
                new Timezone("GMT+08:00"), new ContractExpiryDate("23-12-2020"),
            ...
            new Client(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                ...
                new Timezone("GMT+08:00"), new ContractExpiryDate("3-2-2021"),
                new LastModifiedInstant("2020-05-05T00:00:00.000000Z")),
            new Client(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                ...
                new Timezone("GMT+08:00"), new ContractExpiryDate("9-6-2024"),
                new LastModifiedInstant("2020-06-06T00:00:00.000000Z"))
        };
    }
