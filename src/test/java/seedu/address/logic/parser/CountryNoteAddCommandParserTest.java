...
public class CountryNoteAddCommandParserTest {
    ...
    @Test
    public void parse() {
        // EP: no country + no note -> parseException
        assertThrows(ParseException.class, () -> parser.parse(" random string"));

        // EP: with preamble -> parseException
        ...
        // EP: has country + no note -> parseException
        ...
        // EP: invalid country + has note -> parseException
        ...
        // EP: valid country + no note -> parseException
        ...
        // EP: valid country + has note + no untagged -> false
        ...
        // EP: valid country + has note + has untagged -> true
        countryNote = new CountryNote("random string", new Country("SG"));
