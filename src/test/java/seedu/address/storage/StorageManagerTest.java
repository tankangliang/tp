...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTbmManagerStorage tbmManagerStorage = new JsonTbmManagerStorage(getTempFilePath("tm"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        storageManager = new StorageManager(tbmManagerStorage, userPrefsStorage);
    }
    ...
    @Test
    public void tbmManagerReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is properly wired to the
         * {@link JsonTbmManagerStorage} class.
         * More extensive testing of UserPref saving/reading is done in {@link JsonTbmManagerStorageTest} class.
         */
    ...
    @Test
    public void getTbmManagerFilePath() {
        assertNotNull(storageManager.getTbmManagerFilePath());
    }
