...
* **Display Panel** shall render *Client Cards* or *Country Cards* when relevant commands are sent. Initially it will show you your local time to the precise second, as well as your current location.
